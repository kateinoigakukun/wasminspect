...
pub fn transform_inst(reader: &OperatorsReader) -> Result<Instruction> {
    ...
    let kind = match op {
        ...
        RefNull => InstructionKind::RefNull,
        ...
        I8x16Mul => InstructionKind::I8x16Mul,
        ...
        I64x2AnyTrue => InstructionKind::I64x2AnyTrue,
        ...
        I64x2TruncSatF64x2S => InstructionKind::I64x2TruncSatF64x2S,
        I64x2TruncSatF64x2U => InstructionKind::I64x2TruncSatF64x2U,
        F32x4ConvertI32x4S => InstructionKind::F32x4ConvertI32x4S,
        F32x4ConvertI32x4U => InstructionKind::F32x4ConvertI32x4U,
        F64x2ConvertI64x2S => InstructionKind::F64x2ConvertI64x2S,
        F64x2ConvertI64x2U => InstructionKind::F64x2ConvertI64x2U,
